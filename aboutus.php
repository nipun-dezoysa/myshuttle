...
<html lang="en">
  <head>
   ...
   <!-- card section -->
  <section class="main-card-section" id="about-section">
  <center>
  <div class="card-section">
   <div class="container mt-5">
    <h1 class="text-center mb-5 text-dark ">Meet Our Team</h1>
    <div class="row">
      
      <div class="col-md-6 col-lg-3">
        <div class="team-card">
          <div class="image-container">
            <img src="./images/nipun.jpg" class="img-fluid rounded-circle" alt="Team Member">
          </div>
          <h4>Nipun Avishka</h4>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="team-card">
          <div class="image-container">
            <img src="./images/sameera.jpeg" class="img-fluid rounded-circle" alt="Team Member">
          </div>
          <h4>Sameera Jayakodi</h4>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="team-card">
          <div class="image-container">
            <img src="./images/sanjeewa.jpg" class="img-fluid rounded-circle" alt="Team Member">
          </div>
          <h4>Sanjeewa Deshapriya</h4>
          <p>Developer</p>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="team-card">
          <div class="image-container">
            <img src="./images/chithraka.jpg" class="img-fluid rounded-circle" alt="Team Member">
          </div>
          <h4>Chithraka Kalnamith</h4>
          <p>UI/UX</p>
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="team-card">
            <div class="image-container">
              <img src="./images/sakuni.jpg" class="img-fluid rounded-circle" alt="Team Member">
            </div>
            <h4>Sakuni Sirimanna</h4>
            <p>QA & Researcher</p>
        ...
        <div class="col-md-6 col-lg-3">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-card">
              <div class="image-container">
                <img src="./images/ravidu.jpg" class="img-fluid rounded-circle" alt="Team Member">
              </div>
              <h4>Ravindu Induwara</h4>
              <p>Researcher</p>
      ...
      <div class="container">
        <div class="row" >
          <div class="col-md-6">
            ...
            <img src="./images/nsbm.jpg" alt="Nsbm" class="nsbm-img">
          </div>
          <div class="col-md-6">
            ...
            <p class="about-description logo"><span style="font-size: 18px; font-weight:500;"><a href="https://www.nsbm.ac.lk/" target="_blank">NSBM Green University</a></span>, the nation’s premier degree-awarding institute, is the first of its kind in South Asia. It is a government-owned self-financed institute that operates under the purview of the Ministry of Education. As a leading educational centre in the country, NSBM has evolved into becoming a highly responsible higher education institute that offers unique opportunities and holistic education on par with international standards while promoting sustainable living.
              ...
              Focused on producing competent professionals and innovative entrepreneurs for the increasingly globalising world, NSBM nurtures its graduates to become productive citizens of society with their specialisation ranging in study fields such as Business, Management, Computing, IT, Engineering, Science, Psychology, Nursing, Interior design, Quantity Surveying, Law and Multimedia. <br><br><br>
              ...
              Nestling on a 40-acre land amidst the greenery and serenity in Pitipana, Homagama, NSBM Green University, is an ultra-modern university complex constructed with state-of-the-art facilities and amenities that provides the perfect setting for high-quality teaching, learning and research.</p>
          </div>
        </div>
      </div>
    </section>  
